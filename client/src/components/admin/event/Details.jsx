...
function Details({event}) {
  return (
    <div className="max-w-auto h-full mx-auto rounded-lg bg-violet-400" style={{margin:0}}>
      ...
      <div className="p-6">
        <h2 className="text-3xl font-semibold text-white m-4">{event.name.trim().toUpperCase()}</h2>
        ...
        <div className="flex items-center mt-2 text-gray-600">
          ...
          <span className='text-gray-700 text-sm'>{(event?.startTime) && (
        ...
        {/* Description */}
        <p className="mt-4 text-gray-700 px-2 text-base">{event?.description}</p>
