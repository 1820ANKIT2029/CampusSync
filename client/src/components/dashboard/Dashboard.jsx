...
import { fetchuserstats } from '../../redux/features/user/userStatsSlice.js';
...
const Dashboard = () => {
  const {name,username,email,aura,year,branch,profilePic,status} = useSelector((state) => state.userProfile);
  ...
  return (
    <>
      <div className="flex bg-blue-100 lg:w-full">
        <div className="flex-grow flex flex-col items-center justify-center overflow-y-auto px-8">
          <div className="flex flex-col items-center justify-center py-8 lg:w-3/4">
