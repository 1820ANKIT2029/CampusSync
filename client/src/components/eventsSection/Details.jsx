...
function Details() {
  return (
    <div className="max-w-auto h-full mx-auto rounded-lg bg-violet-400" style={{margin:0}}>
      ...
      <div className="p-6">
        <h2 className="text-3xl font-semibold text-white m-4">Event's Name</h2>
        ...
        <div className="flex items-center mt-2 text-gray-600">
          ...
          <span className='text-gray-700 text-sm'>Nov 11, 2024</span>
        </div>
        ...
        <div  className="flex items-center mt-2 text-gray-600">
          ...
          <span className='text-gray-700 text-sm'>Academic Block</span>
        </div>

        {/* Description */}
        <p className="mt-4 text-gray-700 px-2 text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, magnam nobis odit nihil quos rem laboriosam illo accusantium necessitatibus laudantium commodi doloribus, adipisci id modi?</p>
